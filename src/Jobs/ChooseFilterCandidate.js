...
export default class ChooseFilterCandidate extends Component {
    constructor() {
        super();
        this.state = {
            ratingModal:false,
        ...
        for (let i = 1; i < 3; i++) {
            ...
            paymentdata.push(
                ...
                isChecked={this.state.isChecked2}
                  ...
                  checkedImage={<Image source={require('../assets/icons/check.png')} style={{width: 16, height: 16}}/>}
                  unCheckedImage={<Image source={require('../assets/icons/uncheck.png')} style={{width: 16, height: 16}}/>}
                /> 
            ...
            <ScrollView>
                ...
                /> 
                    ...
                    <TouchableOpacity onPress={() => { this.FormSubmit() }}>
                        <LinearGradient start={{ x: -0.5, y: 1.0 }} end={{ x: 1.3, y: 1.0 }} colors={['#DE00A7', '#8000CD', '#4637EE']} style={styles.mainbtn}>
                            <Text style={styles.mainbtntxt}>Offer to Workers</Text>
                        </LinearGradient>
                    </TouchableOpacity>
